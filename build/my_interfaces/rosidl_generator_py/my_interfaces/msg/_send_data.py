...
class SendData(metaclass=Metaclass_SendData):
    ...
    def __init__(self, **kwargs):
        ...
        self.tg_num = kwargs.get('tg_num', int())
    ...
    @builtins.property
    def tg_num(self):
        """Message field 'tg_num'."""
        return self._tg_num

    @tg_num.setter
    def tg_num(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'tg_num' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'tg_num' field must be an integer in [-128, 127]"
        self._tg_num = value
