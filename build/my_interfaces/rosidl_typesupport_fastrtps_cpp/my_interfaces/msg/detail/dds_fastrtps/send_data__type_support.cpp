...
#include "my_interfaces/msg/detail/send_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::SendData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::SendData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: tg_num
  {
    size_t item_size = sizeof(ros_message.tg_num);
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::SendData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::SendData *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_SendData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, SendData)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_SendData__handle;
}
